...
### Error messages which display if the user's input is not valid.
![Screen Shot 2023-01-20 at 05 44 30](https://user-images.githubusercontent.com/107034179/213625951-b2052e01-9ac2-4517-9540-22c606758521.png)
...
Occasionally when the user selects their city from the suggestions list it does not update the weather city H2 accordingly will can display a city of the same name but from a different country. This issue does not happen regularly and seeminlgy only happens with certain cities. Unfortunately this could not be resolved at the time of submission and will need to be fixed in a future update.  
